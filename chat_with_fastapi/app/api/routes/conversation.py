...
def _build_response(conv, current_user_id: str) -> ConversationResponse:
    members = [
...
async def list_conversations(
    ...
    return [_build_response(c, current_user.id) for c in convs]
...
async def create_conversation(
    ...
    if data.type == "direct" and len(data.user_ids) == 1:
        ...
        if existing:
            ...
            return _build_response(conv, current_user.id)
